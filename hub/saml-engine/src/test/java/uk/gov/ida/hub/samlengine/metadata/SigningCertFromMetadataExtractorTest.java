...
public class SigningCertFromMetadataExtractorTest {
    ...
    @Test
    public void certIsSuccessfullyExtractedFromMetadata() throws ResolverException {
    ...
    public void certIsNotFoundInMetadata() throws ResolverException {
        signingCertFromMetadataExtractor = new SigningCertFromMetadataExtractor(metadataResolver, HUB_ENTITY_ID);
    ...
    public void unableToResolveSigningCert() throws ResolverException {
        signingCertFromMetadataExtractor = new SigningCertFromMetadataExtractor(metadataResolver, HUB_ENTITY_ID);
